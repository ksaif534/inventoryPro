...
<div class="p-6">
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-white mb-2">Create Purchase Order</h1>
        <p class="text-gray-300">Create a new purchase order for your suppliers</p>
    </div>
            ...
            <div class="mb-6">
                ...
                <div class="mt-4 p-4 bg-white/5 rounded-lg border border-white/10">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="glass-badge text-lg">$<span id="order-total">0.00</span></span>
                    </div>
                </div>
...
// Note: User must click "Add Item" to add items to the form
</script>
@endsection